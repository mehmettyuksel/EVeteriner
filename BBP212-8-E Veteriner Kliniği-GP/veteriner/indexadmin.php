...
<body>
   ...
   <div class="slider">
        <div class="slides">
            ...
            <div class="slide">
                <img src="images/kedi.jpg" alt="">
            </div>
            <div class="slide">
                <img src="images/hamster.jpg" alt="">
            </div>
            <div class="slide">
                <img src="images/tavsan.jpg" alt="">
            </div>
...
if(counter>4){
    ...
    <div class="mtn">
        <h2>Güvenilir Ellerdesiniz</h2>
        <p>Onlar herşeyin mükemmelini hak ediyor. E-Veteriner olarak sizler için tüm engellerin üstesinden gelmeye odaklandık.
            Sevgi en iyi ilaçtır.</p>
    </div>
