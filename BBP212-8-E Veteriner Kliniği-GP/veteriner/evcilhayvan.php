...
<body>
   ...
   <div class="slider">
       <h1>Evcil Hayvan Yönetimi</h1>
        <br>
        <br>
		<p>Evcil hayvanlarının gerekli bilgilerini alarak kaydedin. Evcil hayvanlar için medikal kayıt oluşturun ve aşı takvimini planlayın. Aşı takvimini planladıktan sonra tekrar tekrar aşılarla ilgilenmeyin. E-veteriner aşı hatırlatmalarını otomatik olarak yaparak size zaman kazandırır ve aşı uygulandığında bir sonraki aşıyı otomatik olarak ayarlar. Geçmiş aşıları kolay takip etmenizi sağlar. Medikal kayıtları en ince ayrıntısına kadar kaydedin. Hasta şikayeti, hikayesi, fiziksel ve yaşamsal muayene değerleri, tedavi planı ve teşhisleri kaydederek ayrıntılara inin.</p>
    </div>
