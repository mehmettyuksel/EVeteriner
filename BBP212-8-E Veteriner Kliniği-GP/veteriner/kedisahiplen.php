...
<link href="https://fonts.googleapis.com/css2?family=Suranna&family=Trocchi&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="bg-dark-blue">
        <div class="container">
             <nav id="navbar">
            <h1 class="heading-big">Kedi Sahiplen</h1>
            <ul>
    ...
    <center>
      ...
      <div class="wrapper">
         <div class="product-img">
           <img src="gonullu_resim/kedi/kedi1.jpg" height="420" width="327">
         </div>
         <div class="product-info">
           <div class="product-text">
             <h1>Mavi</h1>
             <h2>Cins: Rus Kedisi</h2>
             <p> Oyun oynamayı çok sever. <br> Yaş: Bilinmiyor <br>Sahiplenmek İçin "Sahiplen" Tuşuna Tıklayın <br></p>
           </div>
           <div class="product-price-btn">
             <a href="sahiplen.php" ><button type="button">Sahiplen</button> </a>
           </div>
         </div>
       </div>
 ...
 <div class="wrapper">
     <div class="product-img">
       <img src="gonullu_resim/kedi/kedi2.jpg" height="420" width="327">
     </div>
     <div class="product-info">
       <div class="product-text">
         <h1>Bibo</h1>
   ...
   <div class="wrapper">
      <div class="product-img">
        <img src="gonullu_resim/kedi/kedi3.jpg" height="420" width="327">
      </div>
      <div class="product-info">
        <div class="product-text">
          <h1>Sinirli</h1>
          <h2>Cins: Bilinmiyor</h2>
          <p> Oyun oynamayı çok sever. <br> Yaş: Bilinmiyor <br>Sahiplenmek İçin "Sahiplen" Tuşuna Tıklayın <br></p>
        </div>
        <div class="product-price-btn">
          <a href="sahiplen.php" ><button type="button">Sahiplen</button> </a>
