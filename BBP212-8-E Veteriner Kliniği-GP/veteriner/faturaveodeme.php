...
<body>
   ...
   <div class="slider">
       <h1>Fatura ve Ödeme Takibi</h1>
       <br>
       <br>
        <p>Satın aldığınız ürün ve hizmetler için fatura oluşturun ve stok işlemlerinin otomatik ilerlemesini sağlayın. Ödeme yaptığınızda ödemeyi faturaya işleyin ve faturayı kapatın. Her ödemeyi ayrı ayrı kaydedin. Faturanın bir kısmını ödediyseniz diğer kısmını sonradan ödeyerek  ayrı ayrı kayıt oluşturun. Alınan ödeme işlemleri detaylı saklansın.</p>
    </div>
